class Item < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :price, numericality: {only_integer:true, greater_than:299, less_than:10000000, message: "is invalid. Input number from 300 to 9,999,999."}, format: {with: /\A[0-9]+\Z/, message: "is invalid. Input number."} 
